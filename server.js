...
app.get('/api/seed', async (req, res) => {
    ...
    const experts = [
  {
    ...
    rating: 4.9,
    totalReviews: 187,
    bio: 'AI/ML expert with 12 years experience.',
    hourlyRate: 5000,
  ...
  },
  {
    ...
    rating: 4.8,
    totalReviews: 234,
    bio: 'Serial entrepreneur and consultant.',
    hourlyRate: 6000,
  ...
  },
  {
    ...
    rating: 4.8,
    totalReviews: 145,
    bio: 'Preventive medicine specialist.',
    hourlyRate: 7000,
